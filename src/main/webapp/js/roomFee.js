...
$(function(){
	$("#dg").datagrid({
	idField:"id",
	url:"roomFee/queryByPage",
	fitColumns:true,
	fit:true,
	columns:[[  
		{field:'',checkbox:true},  
        {field:'roomName',title:'房间名称',width:100,align:'center'},    
        {field:'useWater',title:'用水费',width:100,align:'center'},
        {field:'userElectricity',title:'用电费',width:100,align:'center'},
        {field:'roomFee',title:'基本费用',width:100,align:'center'},
