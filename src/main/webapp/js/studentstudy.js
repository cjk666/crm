...
$(function(){
	...
	columns:[[  
        ...
        {field:'schoolName',title:'毕业院校',width:100,align:'center'},
        {field:'schoolMajor',title:'所学专业名称',width:100,align:'center'},
        {field:'beginDate',title:'开班日期',width:100,align:'center'},
        {field:'major',title:'实训专业',width:50,align:'center',formatter: function(value,row,index){
			if (row.major != null) {
        ...
        {field:'contractFile',title:'合同文件名',width:100,align:'center'},
        {field:'contractDate',title:'合同签订日期',width:100,align:'center'},
...
function updateDialog(){
	...
	//默认选中
	if (array[0].major != null && array[0].major != "") {
